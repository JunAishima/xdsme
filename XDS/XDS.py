...
class XDS:
    ...
    def run_colspot(self):
        ...
        if EIGER and FRAMES_PER_COLSPOT_SEQUENCE / NUMBER_OF_PROCESSORS < 1:
            self.inpParam["MAXIMUM_NUMBER_OF_JOBS"] = FRAMES_PER_COLSPOT_SEQUENCE / 2 #prevent number of jobs from getting too big
        ...
        while res.results["spot_number"] < MIN_SPOT_NUMBER and _trial < 4:
            ...
            if self.inpParam["STRONG_PIXEL"] - 1 >= 2.0:
                self.inpParam["STRONG_PIXEL"] -= 1.
            else: # prevent going below 2 sigma
                break
...
if __name__ == "__main__":
    ...
    short_opt =  "123456aAbBc:d:E:f:F:i:Il:L:O:M:n:p:s:Sr:R:t:x:y:vw:WSFX"
    long_opt = ["anomal",
                "Anomal",
                "beam-x=",
                "beam-y=",
